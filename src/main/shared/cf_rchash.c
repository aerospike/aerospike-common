 ...
 *
 * @chris: 	I don't know why these are here instead of the header file. Either
 * 			move them to the header file or make them static. No reason to
 * 			have "dangling" symbols.
 *
 ******************************************************************************/
