...
typedef enum paxos_recovery_policy_enum { AS_PAXOS_RECOVERY_POLICY_UNDEF, AS_PAXOS_RECOVERY_POLICY_MANUAL, AS_PAXOS_RECOVERY_POLICY_AUTO_DUN_MASTER } paxos_recovery_policy_enum;
